  ...
  return (
    <main className="page">
      ...
      <header className="promoHeader">
        <Link href="/" className="brand" aria-label="Vistiq Invitation">
          <p>VISTIQ</p>
          <h1>Invitation</h1>
        </Link>
