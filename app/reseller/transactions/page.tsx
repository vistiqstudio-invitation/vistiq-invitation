...
export default function ResellerTransactionsPage() {
  ...
  const totalKomisi = transactions.reduce((sum, item) => sum + Number(item.commission || 0), 0);
    ...
    <main className={styles.page} style={brandStyle}>
      ...
      <section className={styles.content}>
        <header className={styles.header}>
          ...
          <button onClick={() => reseller && fetchTransactions(reseller.id)} className={styles.button}>
            Refresh
          </button>
        </header>
        ...
        {loading ? (
          ...
          <section className={styles.warningBox}>
            <h2>Paket Reseller Brand tidak menghasilkan komisi.</h2>
            <p>Anda menyimpan 100% dari harga yang Anda tetapkan sendiri ke client.</p>
          </section>
        ) : (
          <>
            <section className={styles.stats}>
              ...
              <div className={styles.statCard}>
                <span>Komisi Sudah Dibayar</span>
            ...
            <section className={styles.tableWrap}>
              ...
              {transactions.length === 0 ? (
                <p>Belum ada transaksi. Komisi otomatis muncul saat Anda menambahkan client baru.</p>
              ) : (
