    ...
    <main className="page">
      ...
      <section className="cta">
        ...
        <div className="actions centered">
          <CheckoutButton packageId="reseller" label="Join Reseller Rp59.000" featured production={midtransProduction} />
        </div>
      </section>
