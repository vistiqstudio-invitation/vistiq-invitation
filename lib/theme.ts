...
export const themeList: ThemeMeta[] = [
  ...
  { key: "3d-motion", label: "3D Motion — Garden Romance", description: "Sage, ivory dan floral transparan dengan cover sinematik, reveal berlapis, galeri masonry dan RSVP", swatch: ["#edf1e6", "#85a57a"], tags: ["luxury-art", "premium"], addedAt: "2026-09-02" },
