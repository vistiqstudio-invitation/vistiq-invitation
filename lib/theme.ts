...
import FizanIslamicMotion from "@/themes/fizan-islamic-motion/FizanIslamicMotion";
...
export const themeList: ThemeMeta[] = [
  ...
  { key: "emerald-lantern", label: "Emerald Lantern", description: "Nuansa malam taman, awan lembut & lampion hijau jade", swatch: ["#fbfaf6", "#5b8266"], tags: ["basic"] },
  { key: "sakura", label: "Sakura", description: "Pink lembut, bunga sakura melayang, soft & feminin", swatch: ["#fffaf9", "#c2607a"], tags: ["basic"] },
  { key: "rustic", label: "Rustic", description: "Kraft & terracotta, gandum kering, hangat & earthy", swatch: ["#faf3e6", "#c17a54"], tags: ["basic"] },
  ...
  { key: "menara-cahaya", label: "Menara Cahaya", description: "Navy malam & emas, siluet kubah-menara masjid, bintang islami", swatch: ["#0d1b3d", "#cda15a"], tags: ["basic"] },
  { key: "santorini", label: "Santorini", description: "Biru Aegean & putih, pintu lengkung Cyclades, editorial minimalis", swatch: ["#f6fafc", "#1c5583"], tags: ["basic"] },
  { key: "vintage-botanical", label: "Vintage Botanical", description: "Kertas usang, sage & maroon pudar, plakat botani, galeri masonry", swatch: ["#f6efe0", "#7d3f3a"], tags: ["basic"] },
  ...
  { key: "art-deco-glam", label: "Art Deco Glam", description: "Onyx, emerald & emas geometris ala 1920-an, bingkai heksagon", swatch: ["#0d0d0f", "#c9a648"], tags: ["basic"] },
  ...
  { key: "sahara", label: "Sahara", description: "Krem & terracotta pasir, foto arch tinggi, galeri grid lightbox, story dua kolom", swatch: ["#fffdf9", "#ae8f7a"], tags: ["basic"] },
  { key: "midnight-aurora", label: "Midnight Aurora", description: "Navy-ungu malam, aurora bergerak, orbit perak & aksen konstelasi", swatch: ["#071126", "#a88bff"], tags: ["basic"] },
  ...
  { key: "fizan-islamic-motion", label: "Fizan Islamic 3D Motion", description: "Opening video masjid 3D, bingkai putih-emas, hijau sage, ayat, event, gallery, gift, RSVP dan ucapan", swatch: ["#faf3e7", "#6e9277"], tags: ["premium", "premium-3d-motion"], addedAt: "2026-09-05" },
  { key: "porcelain-bloom", label: "Porcelain Bloom", description: "Ivory & powder blue, porselen klasik, mutiara, pita satin & floral biru", swatch: ["#fbfaf6", "#2d638f"], tags: ["basic"] },
  { key: "love-chronicle", label: "Love Chronicle", description: "Champagne & burgundy, wedding newspaper, cap pos, perangko & wax seal", swatch: ["#f4eddf", "#7a2433"], tags: ["basic"] },
  { key: "velvet-cinema", label: "Velvet Cinema", description: "Merah beludru & hitam, premiere film, marquee lights, tiket VIP & filmstrip", swatch: ["#0a0909", "#761423"], tags: ["basic"] },
  { key: "prismatic-vows", label: "Prismatic Vows", description: "Indigo, lilac & cyan, kaca holografik, prisma cahaya & galeri refraksi", swatch: ["#0c0b1d", "#76e7ef"], tags: ["basic"] },
  { key: "pearl-tide", label: "Pearl Tide", description: "Deep ocean & seafoam, kerang, mutiara, riak air & bingkai pesisir organik", swatch: ["#071f29", "#dcebea"], tags: ["basic"] },
];
