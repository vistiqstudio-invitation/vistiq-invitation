...
import AzureBloom from "@/themes/azure-bloom/AzureBloom";
...
const allWeddingThemes: ThemeMeta[] = [
  ...
  { key: "luxury-art-garden", label: "Luxury Art — Garden Valley", description: "Luxury art bernuansa midnight blue, botanical relief, bingkai galeri & aksen antique gold", swatch: ["#e8eef5", "#173f67"], tags: ["luxury-art"], addedAt: "2026-08-21" },
  ...
  { key: "lavender-garden-motion", label: "Lavender Garden Motion", description: "Lavender, ivory dan floral watercolor dengan cover video sinematik, galeri, gift, RSVP dan wishes", swatch: ["#fffcf3", "#9e99bf"], tags: ["premium-3d-motion"], addedAt: "2026-09-02" },
  ...
  { key: "adat-bali-motion", label: "Adat Bali 3D Motion", description: "Duplikasi 3D Motion Adat Bali dengan nuansa Bali, aksen ungu & emas, opening video, galeri, gift, RSVP dan ucapan", swatch: ["#2b0b46", "#7c2aa7"], tags: ["premium-3d-motion", "3d-motion-adat", "adat"], addedAt: "2026-09-18" },
