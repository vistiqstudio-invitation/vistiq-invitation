    ...
    <div className={styles.hero}>
      <Reveal>
        ...
        <p className={styles.heroDesc}>
          Adat basandi syarak, syarak basandi Kitabullah. Menjadi kehormatan
          bagi kami apabila Bapak/Ibu/Saudara/i berkenan memberikan doa
          restu di hari yang berbahagia ini.
        </p>
      </Reveal>
