...
export default function Cover({ invitation }: { invitation: AqiqahInvitationData }) {
  ...
  return (
    ...
    >
      <img className={styles.coverCornerTL} src="/photos/akikah-zaitun-floral-a.webp" alt="" aria-hidden="true" />
      <img className={styles.coverCornerBL} src="/photos/akikah-zaitun-floral-a.webp" alt="" aria-hidden="true" />
      <img className={styles.coverCornerBR} src="/photos/akikah-zaitun-floral-a.webp" alt="" aria-hidden="true" />
