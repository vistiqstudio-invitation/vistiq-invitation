...
function GiftCard({ account }: { account: GiftAccount }) {
  ...
  return (
    <div className={styles.giftCard}>
      <p className={styles.giftOwner}>Tanda Kasih</p>
...
export default function Gift({ invitation }: { invitation: AqiqahInvitationData }) {
  if (invitation.gifts.length === 0) return null;

  return (
    <div className={styles.section}>
      <Reveal>
        <p className={styles.eyebrow}>Aqiqah Gift</p>
        <h2 className={styles.title}>Kado</h2>
      </Reveal>
