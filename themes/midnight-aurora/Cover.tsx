...
import AuroraAccents from "./AuroraAccents";
...
export default function Cover({ invitation }: { invitation: InvitationData }) {
  ...
  return (
    ...
    >
      ...
      <AuroraAccents className={styles.coverAurora} />
      <AuroraAccents variant="corner" className={`${styles.cornerAccent} ${styles.cornerTopLeft}`} />
      <AuroraAccents variant="corner" className={`${styles.cornerAccent} ${styles.cornerBottomRight}`} />
      ...
      >
        <div className={styles.celestialSeal} aria-hidden="true"><span>✦</span></div>
        <p className={styles.coverTop}>Under The Same Sky</p>
      ...
      >
        <div className={styles.guestOrbit} aria-hidden="true"><span /></div>
