...
export default function MidnightAurora({ invitation }: { invitation: InvitationData }) {
  ...
  return (
    <div className={styles.root}>
      ...
      {ready && opened && (
        <>
          <AuroraAccents className={styles.ambientAurora} />
          <section id="home">
            <Hero invitation={invitation} />
          </section>

          <AuroraAccents variant="divider" className={styles.sectionDivider} />
