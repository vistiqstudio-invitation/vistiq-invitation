      ...
      <Reveal>
        ...
        {opening?.title ? (
          ...
          <h2 className={styles.heroTitle}>
            ...
            menjadi saksi dan mendoakan pernikahan kami,{" "}
        ...
        <p className={styles.heroDesc}>
          {opening?.description ||
            "Kehadiran dan doa restu Bapak/Ibu/Saudara/i akan menjadi awal yang indah bagi perjalanan panjang kami berdua."}
        </p>
      </Reveal>
