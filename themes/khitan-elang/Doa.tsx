    ...
    <div className={styles.doaSection}>
      <Reveal>
        ...
        <p className={styles.doaQuote}>
          ...
          {nickname} menjadi anak yang tajam pandangannya dalam kebaikan,
          sholeh, sehat, berbakti kepada orang tua, berguna bagi agama &
          bangsa, serta senantiasa dalam lindungan Allah SWT.
          <br />
          <br />
