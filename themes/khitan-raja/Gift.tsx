...
function GiftCard({ account }: { account: GiftAccount }) {
  ...
  return (
    <div className={styles.giftCard}>
      <p className={styles.giftOwner}>Khitan Gift</p>
...
export default function Gift({ invitation }: { invitation: KhitanInvitationData }) {
  if (invitation.gifts.length === 0) return null;

  return (
    <div className={styles.section}>
      <Reveal>
        <h2 className={styles.title}>Khitan Gift</h2>
      </Reveal>
