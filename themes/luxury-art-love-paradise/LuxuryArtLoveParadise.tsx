...
type IconName = "home" | "couple" | "calendar" | "gallery" | "heart" | "chat" | "gift" | "music" | "pin" | "copy" | "envelope";
...
export default function LuxuryArtLoveParadise({ invitation }: { invitation: InvitationData }) {
