...
export default function Cover({ invitation }: { invitation: InvitationData }) {
  ...
  return (
    ...
    >
      ...
      <RoyalCrest className={`${styles.crest} ${styles.crestTopLeft}`} />
      <RoyalCrest className={`${styles.crest} ${styles.crestTopRight}`} />
      <RoyalCrest className={`${styles.crest} ${styles.crestBottomLeft}`} />
