  ...
  return (
    ...
    >
      <div className={styles.loadingPlate}>
        <span>V</span>
        <small>Princess Fairytale</small>
      </div>
    </motion.div>
  );
}
    ...
    >
      ...
      >
        <p className={styles.coverLabel}>
          {invitation.opening?.title || "Once Upon a Wedding"}
        </p>
...
function Hero({ invitation }: { invitation: InvitationData }) {
  return (
    <div className={`${styles.section} ${styles.hero}`}>
      <PrincessCorner className={`${styles.sectionCorner} ${styles.sectionCornerLeft}`} />
      <Reveal>
        ...
        <h2 className={styles.heroTitle}>
          Once upon a time,<br />dua hati menemukan selamanya.
        </h2>
...
function Countdown({ targetDate }: { targetDate: string }) {
  ...
  return (
    <div className={styles.countdownBand}>
      <PrincessCorner className={`${styles.bandCorner} ${styles.bandCornerLeft}`} />
      <PrincessCorner className={`${styles.bandCorner} ${styles.bandCornerRight}`} mirrored />
      <Reveal>
...
function Footer({ invitation }: { invitation: InvitationData }) {
  return (
    <footer className={styles.footer}>
      <PrincessCorner className={`${styles.footerCorner} ${styles.footerCornerLeft}`} />
      <PrincessCorner className={`${styles.footerCorner} ${styles.footerCornerRight}`} mirrored />
      <Reveal>
...
export default function PrincessFairytale({ invitation }: { invitation: InvitationData }) {
    ...
    <div className={styles.root}>
      ...
      {ready && opened && (
        <>
          ...
          <PrincessDivider className={styles.sectionBreak} />
