...
export function PorcelainCorner({ className, mirrored = false }: AccentProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 260 260"
...
export function PorcelainDivider({ className }: { className?: string }) {
  return (
    <div className={`${styles.porcelainDivider} ${className || ""}`} aria-hidden="true">
