  ...
  return (
    <div className={`${styles.section} ${styles.hero}`}>
      ...
      <Reveal>
        ...
        {invitation.events[0]?.date && <p className={styles.heroCopy}>{invitation.events[0].date}</p>}
      </Reveal>
...
function Couple({ invitation }: { invitation: InvitationData }) {
  return (
    <div className={`${styles.section} ${styles.coupleSection}`}>
      <Reveal>
        <div className={styles.openingGreeting}>
          <p className={styles.arabic}>بِسْمِ اللّٰهِ الرَّحْمٰنِ الرَّحِيْمِ</p>
          <h2>Assalamu’alaikum Wr. Wb.</h2>
          <p>Dengan memohon rahmat dan ridho Allah Subhanahu Wa Ta’ala, insyaa Allah kami akan menyelenggarakan acara pernikahan.</p>
        </div>
      </Reveal>
